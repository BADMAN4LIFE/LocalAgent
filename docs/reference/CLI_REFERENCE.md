...
- TUI Learn Overlay keeps promote controls beginner-focused (`target` + `force` + direct publish on Enter). Advanced promote flags remain available through typed `/learn promote ...` or CLI.
